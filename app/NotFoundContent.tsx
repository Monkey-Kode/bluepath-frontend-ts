  ...
  return (
    <main className="header-offset bg-white text-blue pb-20 px-5 flex items-center justify-center min-h-[calc(100vh-var(--header-height,100px))]">
      <div className="max-w-[720px] mx-auto text-center">
        ...
        />
        <h1 className="font-sans font-bold text-blue tracking-[0.04em] text-[clamp(1.25rem,_2vw,_1.75rem)] leading-[1.2] m-0 mb-4">
          Page Not Found
        </h1>
        <p className="font-serif text-black text-base leading-[1.6] m-0 mb-8">
