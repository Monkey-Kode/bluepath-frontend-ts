    ...
    <AnimatePresence key={id}>
      ...
      >
        ...
        >
          ...
          {text && (
            <div className="col-[2/4] row-[2/4] px-8 py-4 leading-[1.4] font-thin text-white min-[500px]:columns-2 [&_p]:pr-4 [&_p]:pb-2 [&_p]:m-0 [&_p]:text-justify [&_p]:text-xs max-tablet:[&_p]:font-normal max-tablet:[&_p]:text-left max-tablet:[&_p]:text-[0.65rem] max-tablet:[&_p]:break-words">
